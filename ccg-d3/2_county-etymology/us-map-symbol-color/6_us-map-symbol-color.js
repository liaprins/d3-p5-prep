...
d3.selectAll('.filter-language')
  .on('click', function() {
    var clickedFilterLanguage = this.getAttribute('data-language');
    // d3.select(this).style('border', '2px black solid');
    d3.selectAll('.centroid-symbol')
      .style('stroke-width', 2) // this clears out any previous filters
      .filter(function(d) {
...
d3.selectAll('.filter-etymology')
  .on('click', function() {
    ...
    console.log(clickedFilterEtymology);
    d3.selectAll('.centroid-symbol')
      .style('stroke-width', 2) // this clears out any previous filters
      .filter(function(d) {
